...
const services = [
 ...
 },
 {
  number: '03',
  title: 'Signal report',
  body: 'You get a channel breakdown and feedback summary so you can see what moved, what confused people, and where the next push should go.',
  ...
  <section id="what-we-do" className="relative overflow-hidden border-b border-line bg-ink px-5 py-24 lg:px-8">
   ...
   <div className="relative mx-auto max-w-7xl">
    <SectionHeader
     eyebrow="Services"
     title="What we do"
     description="Seedlift runs the first distribution push for you: we find likely users, route them into the product, and send back what we learned."
    />
